...
from .siglip_ToMe_encoder import ToMESigLipVisionTower
...
def build_vision_tower(vision_tower_cfg, **kwargs):
    ...
    ToME=getattr(vision_tower_cfg, "ToME",False)
    if is_absolute_path_exists or vision_tower.startswith("openai") or vision_tower.startswith("laion") or "ShareGPT4V" in vision_tower:
        ...
        if ToME:
            print("++++++++ in me ")
            return ToMESigLipVisionTower(vision_tower, vision_tower_cfg=vision_tower_cfg, **kwargs)
