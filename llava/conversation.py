...
conv_qwen_sq = Conversation(
    system="""<|im_start|>system
You are a helpful assistant. The AI assistant is also a curious virtual user. The virtual user asks complex questions that are relevant to the content in the image. Again, do not ask about uncertain details.""",
    roles=("<|im_start|>user", "<|im_start|>assistant","<|im_start|>vuser"),
    version="qwen_sq",
    messages=[],
    offset=0,
    sep_style=SeparatorStyle.CHATML,
