ACCELERATE_CPU_AFFINITY=1 torchrun --nproc_per_node=8 --nnodes=1  \
    ...
    --version qwen_sq\
    --sdo_alpha_a 2.0 --sdo_alpha_q 1.0 --beta 0.1 --gamma 0.1 --lamda 50\
    ...
    --bf16 True \
    --run_name ours-7b-qwen-lora-sdo-g0.1-lr1e5-lmd50-3epo \
    --output_dir "./checkpoints/ours-7b-qwen-lora-sdo-g0.1-lr1e5-alpa2.0-alpq1.0-lmd50-3epo" \
    --num_train_epochs 3 \
