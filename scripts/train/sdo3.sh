ACCELERATE_CPU_AFFINITY=1 torchrun --nproc_per_node=8 --nnodes=1  \
    ...
    --bf16 True \
    --run_name ours-7b-qwen-lora-sdo-lr1e6-apa1.2-b0.2-lmd10-2epo-prefharderV1 \
    --output_dir "./checkpoints/ours-7b-qwen-lora-sdo-lr1e6-apa1.2-b0.2-lmd10-apa1.5-2epo-prefharderV1" \
    --num_train_epochs 2 \
